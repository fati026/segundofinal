        ...
        <div class="container mt-4">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div>
                    ...
                    <a class="btn btn-outline-danger" href="ControladorCompra?accion=listar">Compras</a>
                     <a class="btn btn-outline-danger" href="ControladorCompraDetalle?accion=listar">Compra_detalle</a>
                     <a class="btn btn-outline-danger" href="ControladorVenta?accion=listar">Ventas</a>
                      <a class="btn btn-outline-danger" href="ControladorVentaDetalle?accion=listar">Venta_detalle</a>
                </div>
                <% } } %>
