...
<head>
    ...
    <title>Sistema de Gestión - Agregar Venta</title>
        ...
        <form action="ControladorVenta" method="POST">
            <div class="card border-info mb-4">
                ...
                <div class="card-body text-info">
                    ...
                    <div class="form-group">
                        <label for="txtClienteId">Cliente</label>
                        <input type="text" name="txtClienteId" id="txtClienteId" class="form-control" required>
                    </div>
