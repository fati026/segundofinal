...
<head>
    ...
    <title>Sistema de Gestión - Agregar Detalle de Compra</title>
            ...
            <div class="card border-info mb-4">
                ...
                <div class="card-body text-info">
                    <div class="form-group">
                        <label for="txtCompraId">ID de Compra</label>
                        <input type="text" name="txtCompraId" id="txtCompraId" class="form-control" required>
                    </div>
                    <div class="form-group">
